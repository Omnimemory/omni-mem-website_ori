...
export function MemoryAgentDemo() {
  // --- State ---
  ...
  return (
    <div data-demo-component className="w-full h-[800px] bg-[rgb(var(--deep-blue))] text-white overflow-hidden flex flex-col font-sans selection:bg-[rgb(var(--teal))] selection:text-white rounded-[14px] border border-[rgb(var(--ink-muted))]/20">
      {/* Header */}
      <header className="h-14 flex items-center justify-between px-6 border-b border-[rgb(var(--ink-muted))]/20 bg-[rgb(var(--deep-blue))]/50 backdrop-blur-sm z-50 shrink-0">
        <div className="flex items-center gap-3">
           <div className="relative flex h-3 w-3">
             <span className={`relative inline-flex rounded-full h-3 w-3 ${isProcessing ? 'bg-[rgb(var(--teal))]' : 'bg-[rgb(var(--teal))]'}`}></span>
             {isProcessing && <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[rgb(var(--teal))] opacity-75"></span>}
           </div>
           <h1 className="text-lg font-bold tracking-tight text-white flex items-center gap-2" style={{ fontFamily: 'var(--font-serif)' }}>
             ContextOS <span className="text-[rgb(var(--ink-muted))] font-normal" style={{ fontFamily: 'var(--font-sans)' }}>Memory Agent</span>
           </h1>
        </div>
        <div className="flex items-center gap-4 text-xs font-medium text-[rgb(var(--ink-muted))]">
           <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[rgb(var(--deep-blue))] border border-[rgb(var(--ink-muted))]/20">
             <Zap className="w-3 h-3 text-[rgb(var(--teal))]" />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-[30%] min-w-[320px] max-w-[400px] flex flex-col border-r border-[rgb(var(--ink-muted))]/20 bg-[rgb(var(--deep-blue))]">
          ...
          {/* 2. Processing Logs */}
          <div className="p-4 border-b border-[rgb(var(--ink-muted))]/20 shrink-0">
             <ProcessingStatus 
              stages={stages} 
              logs={logs} 
          ...
          <div className="flex-1 min-h-0 overflow-hidden flex flex-col p-4 bg-[rgb(var(--deep-blue))]/50">
            <div className="flex items-center gap-2 mb-3 px-1">
               <Activity className="w-4 h-4 text-[rgb(var(--teal))]" />
               <h3 className="text-sm font-semibold text-white">Memory Timeline</h3>
            </div>
            <div className="flex-1 rounded-[14px] border border-[rgb(var(--ink-muted))]/20 bg-[rgb(var(--deep-blue))]/50 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[rgb(var(--deep-blue))]">
          
          {/* Top: Knowledge Graph (60% Height) */}
          <div className="flex-[3] min-h-0 relative border-b border-[rgb(var(--ink-muted))]/20 flex flex-col">
             <div className="absolute top-4 left-4 z-10 flex items-center gap-2 px-3 py-1.5 rounded-full bg-[rgb(var(--deep-blue))]/80 border border-[rgb(var(--ink-muted))]/20 backdrop-blur-md shadow-lg">
                <BrainCircuit className="w-4 h-4 text-[rgb(var(--teal))]" />
