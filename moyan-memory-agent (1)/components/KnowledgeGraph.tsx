...
export const KnowledgeGraph: React.FC<KnowledgeGraphProps> = ({ data }) => {
  ...
  useEffect(() => {
    ...
    pattern.append("path")
      ...
      .attr("fill", "none")
      .attr("stroke", "#3f3f46") // theme-border
    ...
    const node = g.append("g")
      ...
      .attr("stroke", (d) => d.isHighlighted ? "#3b82f6" : "#18181b") // Blue or dark
  ...
  return (
    <div ref={wrapperRef} className="w-full h-full bg-[#0c0c0e] relative overflow-hidden">
      {data.nodes.length === 0 && (
         <div className="absolute inset-0 flex flex-col items-center justify-center text-theme-muted/30 gap-3 z-10 pointer-events-none">
            <div className="w-16 h-16 rounded-full border-2 border-dashed border-theme-border/30 animate-[spin_10s_linear_infinite] flex items-center justify-center">
                 <div className="w-8 h-8 rounded-full bg-theme-item/50 backdrop-blur-sm"></div>
            </div>
