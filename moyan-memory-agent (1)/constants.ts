...
// Colors based on STH Schema
const C = {
  MEDIA: '#3f3f46',    // Zinc 700 - Physical/Index
  TIME: '#52525b',     // Zinc 600 - TimeSlice
  EVIDENCE: '#0ea5e9', // Sky 500 - Perception (Evidence/Sensors)
  ASR: '#06b6d4',      // Cyan 500 - Utterance
  ENTITY: '#3b82f6',   // Blue 500 - Entity (Global ID)
  EVENT: '#f59e0b',    // Amber 500 - Event (Process/Atomic)
  KNOWLEDGE: '#8b5cf6',// Violet 500 - Fact/Abstract
  REGION: '#a1a1aa'    // Zinc 400 - Spatial Region
};
